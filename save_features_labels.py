...
def get_features_and_label(pl_id, label,csvfile):
    """
    pl_id: str:: the unique spotify id of a playlist
    label: str:: sad, calm, happy, energetic
    csvfile: str:: name of the csvfile that the retrieved info will be stored
    """
